    ...
    for (var i = 0; i < precision; i++) {
        ...
        if (tool == "bow") {
            ...
            if (tool == "boots") {
                ...
                if (modifiedLevel >= 5 && modifiedLevel <= 15) {
        ...
        // TODO: Add multi-enchants using while(true), make sure you can't get the same enchant class twice by checking the last (1 or 2) enchants in the list, and keeping a record of what enchant # this is
        /*
        ...
        */
        ...
        while (true) {
            ...
            if (Math.random() <= (modifiedLevel + 1) / 50 && toolEnchantLineNumber < 4) {
                ...
                for (var possibleEnchantsIndex = 0; possibleEnchantsIndex < possibleEnchants.length; possibleEnchantsIndex++) {
                    // Don't get same enchant twice
                    $.each(possibleEnchants, function(ix){
                        if(possibleEnchants[ix] == currentEnchantLine){
                            possibleEnchants.splice(ix,1);
                        }
                    });
                    
                    // TODO: Don't allow conflicting enchants
                }
            } else {
                break;
            }
